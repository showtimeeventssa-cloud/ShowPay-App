const CACHE='showpay-artist-v4';
const CORE=['./','./index.html','./manifest.webmanifest','./assets/showpay-logo.png','./assets/showpay-artwork.png','./assets/icon-180.png','./assets/icon-192.png','./assets/icon-512.png'];
